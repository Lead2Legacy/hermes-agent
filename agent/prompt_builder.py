...
def _load_hermes_home_doc(filename: str, context_length: Optional[int] = None) -> Optional[str]:
...
def load_soul_md(context_length: Optional[int] = None) -> Optional[str]:
    ...
    """
    return _load_hermes_home_doc("SOUL.md", context_length)


def load_operating_rules_md(context_length: Optional[int] = None) -> Optional[str]:
    ...
    """
    return _load_hermes_home_doc("OPERATING_RULES.md", context_length)
